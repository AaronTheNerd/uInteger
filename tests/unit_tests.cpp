...
bool test_int_init(uint64_t n) {
    bool result = true;
    atn::uInt u = n;
    TEST("TEST_INT_INIT", 1, uint64_t(u), n)
    return result;
}
...
bool test_decimal_string_init(uint64_t n) {
    ...
    TEST("TEST_DECIMAL_STRING_INIT", 1, uint64_t(u), n)
    return result;
}
...
bool test_hexadecimal_string_init(uint64_t n) {
    ...
    TEST("TEST_HEXADECIMAL_STRING_INIT", 1, uint64_t(u), n)
    u = atn::uInt("0X" + stream.str());
    TEST("TEST_HEXADECIMAL_STRING_INIT", 2, uint64_t(u), n)
    return result;
}
...
bool test_binary_string_init(uint64_t n) {
    ...
    TEST("TEST_BINARY_STRING_INIT", 1, uint64_t(u), n)
    u = atn::uInt("0B" + stream.str());
    TEST("TEST_BINARY_STRING_INIT", 2, uint64_t(u), n)
    return result;
}
...
bool test_uint_to_int(uint64_t n) {
    bool result = true;
    atn::uInt u = n;
    TEST("TEST_UINT_TO_INT", 1, uint64_t(u), n)
    return result;
}
...
bool test_add(uint64_t n1, uint64_t n2) {
    ...
    TEST("TEST_ADD", 1, uint64_t(u1 + u2), n1 + n2)
    TEST("TEST_ADD", 2, uint64_t(u2 + u1), n2 + n1)
    TEST("TEST_ADD", 3, uint64_t(u1 + 1), n1 + 1)
    TEST("TEST_ADD", 4, uint64_t(u2 + 1), n2 + 1)
    TEST("TEST_ADD", 5, uint64_t(u1 + 0), n1 + 0)
    TEST("TEST_ADD", 6, uint64_t(u2 + 0), n2 + 0)
    return result;
}
...
bool test_mul(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_MUL", 1, uint64_t(u1 * u2), n1 * n2)
    TEST("TEST_MUL", 2, uint64_t(u2 * u1), n2 * n1)
    TEST("TEST_MUL", 3, uint64_t(u1 * 1), n1 * 1)
    TEST("TEST_MUL", 4, uint64_t(u2 * 1), n2 * 1)
    TEST("TEST_MUL", 5, uint64_t(u1 * 0), n1 * 0)
    TEST("TEST_MUL", 6, uint64_t(u2 * 0), n2 * 0)
    return result;
}
...
bool test_div(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_DIV", 1, uint64_t(u1 / u2), n1 / n2)
    TEST("TEST_DIV", 2, uint64_t(u2 / u1), n2 / n1)
    TEST("TEST_DIV", 3, uint64_t(u1 / 1), n1 / 1)
    TEST("TEST_DIV", 4, uint64_t(u2 / 1), n2 / 1)
    TEST("TEST_DIV", 5, uint64_t(0 / u1), 0 / n1)
    TEST("TEST_DIV", 6, uint64_t(0 / u2), 0 / n2)
    return result;
}
...
bool test_mod(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_MOD", 1, uint64_t(u1 % u2), n1 % n2)
    TEST("TEST_MOD", 2, uint64_t(u2 % u1), n2 % n1)
    TEST("TEST_MOD", 3, uint64_t(u1 % 1), n1 % 1)
    TEST("TEST_MOD", 4, uint64_t(u2 % 1), n2 % 1)
    TEST("TEST_MOD", 5, uint64_t(0 % u1), 0 % n1)
    TEST("TEST_MOD", 6, uint64_t(0 % u2), 0 % n2)
    return result;
}
...
bool test_shift_left(uint64_t n) {
    bool result = true;
    atn::uInt u = n;
    TEST("TEST_SL", 1, uint64_t(u << 0), n << 0)
    TEST("TEST_SL", 2, uint64_t(u << 1), n << 1)
    TEST("TEST_SL", 3, uint64_t(u << 2), n << 2)
    return result;
}
...
bool test_shift_right(uint64_t n) {
    bool result = true;
    atn::uInt u = n;
    TEST("TEST_SR", 1, uint64_t(u >> 0), n >> 0)
    TEST("TEST_SR", 2, uint64_t(u >> 1), n >> 1)
    TEST("TEST_SR", 3, uint64_t(u >> 2), n >> 2)
    return result;
}
...
bool test_and(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_AND", 1, uint64_t(u1 & u2), n1 & n2)
    TEST("TEST_AND", 2, uint64_t(u2 & u1), n2 & n1)
    TEST("TEST_AND", 3, uint64_t(u1 & 1), n1 & 1)
    TEST("TEST_AND", 4, uint64_t(u2 & 1), n2 & 1)
    TEST("TEST_AND", 5, uint64_t(u1 & 0), n1 & 0)
    TEST("TEST_AND", 6, uint64_t(u2 & 0), n2 & 0)
    return result;
}
...
bool test_or(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_OR", 1, uint64_t(u1 | u2), n1 | n2)
    TEST("TEST_OR", 2, uint64_t(u2 | u1), n2 | n1)
    TEST("TEST_OR", 3, uint64_t(u1 | 1), n1 | 1)
    TEST("TEST_OR", 4, uint64_t(u2 | 1), n2 | 1)
    TEST("TEST_OR", 5, uint64_t(u1 | 0), n1 | 0)
    TEST("TEST_OR", 6, uint64_t(u2 | 0), n2 | 0)
    return result;
}
...
bool test_xor(uint64_t n1, uint64_t n2) {
    bool result = true;
    atn::uInt u1 = n1, u2 = n2;
    TEST("TEST_XOR", 1, uint64_t(u1 ^ u2), n1 ^ n2)
    TEST("TEST_XOR", 2, uint64_t(u2 ^ u1), n2 ^ n1)
    TEST("TEST_XOR", 3, uint64_t(u1 ^ 1), n1 ^ 1)
    TEST("TEST_XOR", 4, uint64_t(u2 ^ 1), n2 ^ 1)
    TEST("TEST_XOR", 5, uint64_t(u1 ^ 0), n1 ^ 0)
    TEST("TEST_XOR", 6, uint64_t(u2 ^ 0), n2 ^ 0)
    return result;
}
...
bool test_to_string(uint64_t n) {
    ...
    std::stringstream stream;
    bool result = true;
    TEST("TEST_TO_STRING", 1, u.to_string(), std::to_string(n))
    TEST("TEST_TO_STRING", 2, u.to_string(2), to_binary_string(n))
    stream << std::oct << n;
    TEST("TEST_TO_STRING", 3, u.to_string(8), stream.str())
    stream.str(std::string());
    stream << std::hex << n;
    TEST("TEST_TO_STRING", 4, u.to_string(16), stream.str())
    TEST("TEST_TO_STRING", 5, u.to_string(64), to_base64_string(n))
    return result;
}
